...
\qa {3} 	qatext={Повесить подкову}
qacheck=["Подкова" in P.Inventory] 	qn={17.0}
\qa {4} 	qatext={Вернуться}
qacheck=[] 	qn={1.0}
\Quest
QID={16}
...
QID={17}
QCheck={}
QText={Вы вешаете подкову на дверь. Она сама поворачивается вокруг своей оси и замирает...  
